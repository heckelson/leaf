...
L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
  maxZoom: 21,
  attribution:
    '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | Die Zweigstelle',
}).addTo(map);
...
function loadTreeData() {
  fetch(request_url + "/trees").then((resp) =>
    resp.json().then((data) => drawTreeData(data)),
  );
}
